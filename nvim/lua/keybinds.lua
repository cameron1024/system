...
map('n', '[g', ':lua vim.lsp.diagnostic.goto_prev({ focusable = false })<CR>')
map('n', ']g', ':lua vim.lsp.diagnostic.goto_next({ focusable = false })<CR>')
map('n', '<C-b>', ':lua vim.lsp.diagnostic.goto_prev({ focusable = false })<CR>')
map('n', '<C-n>', ':lua vim.lsp.diagnostic.goto_next({ focusable = false })<CR>')
